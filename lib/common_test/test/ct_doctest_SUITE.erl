...
docs_filtering_and_error_formatting(_Config) ->
    ...
    expect_error_count(ct_doctest_function_parse_error_mod, [], 5,
                       ["A test failed in function f/0 on line 0",
                        "syntax error before: ')'",
                        "A test failed in function g/0 on line 0",
                        "syntax error before:\n",
                        "A test failed in function h/0 on line 0",
                        "syntax error before: '.'",
                        "A test failed in function i/0 on line 0",
                        "syntax error before:\n",
                        "A test failed in function j/0 on line 1",
                        "syntax error before:\n"
                        ]),
